...
<div class="container text-start">
    <div class="row row-cols-1 row-cols-sm-5 g-3">
        <AddWhiteboardComponent v-bind:addProps="addProps"></AddWhiteboardComponent>
    ...
    <div class="row row-cols-1 row-cols-md-4 g-4">
        ...
        <CardComponent v-bind:whiteboards="whiteboards" v-else></CardComponent>
    </div>
</div>
</template>
<script>
    ...
    methods: {
        getWhiteboards() {
           /* axios.get("Url")
                ...
                .catch(error => console.loge)*/
            setTimeout(() => {
                this.whiteboards = [{title: "whiteboard1", image: "whiteb.svg"},
